...
var jQuery = stacks.jQuery;var $ = jQuery;$(window).load(function(){
  ...
  $('#stacks_in_159 > .display-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
  $('.stacks_top').css({'overflow' : 'visible'});

  var displayMainWrapper = $('#stacks_in_159');
        var displayLabel = $('#stacks_in_159 .display-label');
       var displayTopper = $('#stacks_in_159 .display-topper');
        var expandButton = $('#stacks_in_159-expand-button');
  var collapsableContent = $('#stacks_in_159 .display-collapsable-content');
...
var jQuery = stacks.jQuery;var $ = jQuery;$(window).load(function(){
  ...
  $('#stacks_in_178 > .display-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
  $('.stacks_top').css({'overflow' : 'visible'});

  var displayMainWrapper = $('#stacks_in_178');
        var displayLabel = $('#stacks_in_178 .display-label');
       var displayTopper = $('#stacks_in_178 .display-topper');
        var expandButton = $('#stacks_in_178-expand-button');
  var collapsableContent = $('#stacks_in_178 .display-collapsable-content');
...
var jQuery = stacks.jQuery;var $ = jQuery;$(window).load(function(){
  ...
  $('#stacks_in_191 > .display-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
  $('.stacks_top').css({'overflow' : 'visible'});

  var displayMainWrapper = $('#stacks_in_191');
        var displayLabel = $('#stacks_in_191 .display-label');
       var displayTopper = $('#stacks_in_191 .display-topper');
        var expandButton = $('#stacks_in_191-expand-button');
  var collapsableContent = $('#stacks_in_191 .display-collapsable-content');
